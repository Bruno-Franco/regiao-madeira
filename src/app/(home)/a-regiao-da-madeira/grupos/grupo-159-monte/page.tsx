...
import { PhoneCall, MailIcon, GlobeIcon, MapIcon } from 'lucide-react'
    ...
    <section className="max-w-7xl p-6  text-justify text-base/7  mx-auto text-zinc-700 sm:text-base/8">
      ...
      <div className="flex flex-col sm:flex-row  my-15  sm:justify-start content-center gap-8 ">
        ...
        <div className="sm:w-2/3  md:w-3/4 my-auto">
          ...
          <Link
            href="https://www.google.com/maps/place/A.E.P+-+Grupo+159-Monte/@32.6772349,-16.9048341,17z/data=!3m1!4b1!4m6!3m5!1s0xc60618d61cc7905:0x9fabf3a19227c512!8m2!3d32.6772349!4d-16.9022538!16s%2Fg%2F11sgkmp094?hl=pt-PT&entry=ttu&g_ep=EgoyMDI1MDgzMC4wIKXMDSoASAFQAw%3D%3D"
            className="flex gap-1 w-fit"
            target="_blank"
          >
            <MapIcon className="w-[20px]" /> Vereda da Fonte, n.º 12 ,
            <br />
            Monte, Portugal, 9050-208 FUNCHAL
          </Link>

          <Link
            href="tel:00351924755153"
            className="flex gap-1 w-fit"
          >
            <PhoneCall className="w-[20px]" /> 924755153
          </Link>

          <Link
            href="mailto:grupo159@escoteiros.pt"
            className="flex gap-1 w-fit"
          >
            <MailIcon className="w-[20px]" /> grupo159@escoteiros.pt
          </Link>

          <Link
            href="https://www.grupo159.pt/"
            target="_blank"
            className="flex gap-1 w-fit"
          >
            <GlobeIcon className="w-[20px]" /> www.grupo159.pt
          </Link>
        </div>
      </div>
      <div className="my-7">
